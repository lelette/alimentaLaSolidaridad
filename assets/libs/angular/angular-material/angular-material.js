...
(function() {
   ...
   *   <md-fab-trigger>
   *     <md-button aria-label="Add..."><md-icon icon="/images/icons/plus.svg"></md-icon></md-button>
   *   </md-fab-trigger>
   *
   *   <md-fab-actions>
   *     <md-button aria-label="Add User">
   *       <md-icon icon="/images/icons/user.svg"></md-icon>
   *     </md-button>
   *
   *     <md-button aria-label="Add Group">
   *       <md-icon icon="/images/icons/group.svg"></md-icon>
   *     </md-button>
   *   </md-fab-actions>
   * </md-fab-speed-dial>
   * </hljs>
...
"use strict";
  ...
  /**
    ...
    *
    *     var urls = [ 'imy/app/icons.svg', 'images/icons/android.svg'];
    *
  ...
  *
  *   $mdIcon('images/icons/android.svg').then(function(iconEl) {
 ...
 *     Play Music
 *   </md-tooltip>
 *   <md-icon icon="images/icons/ic_play_arrow_24px.svg"></md-icon>
 * </md-button>
 * </hljs>
 *
 ...
 *   <img ng-src="images/angular.png" class="centered">
 *   <md-tab
 ...
 *     <md-tab-label>
 *       {{tab.title}}
 *       <img src="images/removeTab.png" ng-click="removeTab(tab)" class="delete">
 *     </md-tab-label>
 *     <md-tab-body>
 *       {{tab.content}}
 *     </md-tab-body>
