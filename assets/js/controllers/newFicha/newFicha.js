...
app.controller('newFichaCtrl',
  ['$rootScope', '$scope', '$http', '$state', 'toaster', '$stateParams', '$timeout',
    function ($rootScope, $scope, $http, $state, toaster, $stateParams, $timeout ) {
      /******************************** VARIABLES GLOBALES *****************************/
      ...
      $scope.createKid = function (datos) {
        if ($scope.validateInputs() == true) {
          var enviar = datos;
          enviar.nino.sexo = $scope.ficha.nino.sexoSelect.value;
